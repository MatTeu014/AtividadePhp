...
<head>
    ...
    <title>exercício28</title>
</head>

<body>

    <h2>Volume de uma lata de óleo</h2>
    ...
    <form class ="form-control" method ="POST">
        ...
        <button type="submit" class="btn btn-primary">Calcular
            <?php
                ...
                if(isset($_POST['raio']) && isset($_POST['altura']) && $_POST['raio'] != "" && $_POST['altura'] != ""){
                    $raio = $_POST['raio'];
                    $altura = $_POST['altura'];
                }
            ?>
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" readonly>
            ...
            if(isset($_POST['raio']) && isset($_POST['altura']) && $_POST['raio'] != "" && $_POST['altura'] != ""){                    
                if($raio == ""){
                    ...
                    echo "O volume da lata é: " . lataOleo($raio,$altura);
