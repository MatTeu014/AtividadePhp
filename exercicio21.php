...
<head>
    ...
    <title>exercício21</title>
</head>

<body>

    <h2>Média de Dez Números e Qual é o Maior Deles</h2>
    ...
    <form class ="form-control" method ="POST">
        ...
        <button type="submit" class="btn btn-primary">Calcular
            <?php
                ...
                if(isset($_POST["numero1"]) && isset($_POST["numero2"]) && isset($_POST["numero3"]) && isset($_POST["numero4"]) && isset($_POST["numero5"]) && isset($_POST["numero6"]) && isset($_POST["numero7"]) && isset($_POST["numero8"]) && isset($_POST["numero9"]) && isset($_POST["numero10"]) && $_POST["numero1"] != "" && $_POST["numero2"] != "" && $_POST["numero3"] != "" && $_POST["numero4"] != "" && $_POST["numero5"] != "" && $_POST["numero6"] != "" && $_POST["numero7"] != "" && $_POST["numero8"] != "" && $_POST["numero9"] != "" && $_POST["numero10"] != ""){
                    $num1 = $_POST['numero1'];
                    $num2 = $_POST['numero2'];
                    $num3 = $_POST['numero3'];
                    $num4 = $_POST['numero4'];
    ...
    <div class="form-control">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" readonly>
            <?php
                if(isset($_POST["numero1"]) && isset($_POST["numero2"]) && isset($_POST["numero3"]) && isset($_POST["numero4"]) && isset($_POST["numero5"]) && isset($_POST["numero6"]) && isset($_POST["numero7"]) && isset($_POST["numero8"]) && isset($_POST["numero9"]) && isset($_POST["numero10"]) && $_POST["numero1"] != "" && $_POST["numero2"] != "" && $_POST["numero3"] != "" && $_POST["numero4"] != "" && $_POST["numero5"] != "" && $_POST["numero6"] != "" && $_POST["numero7"] != "" && $_POST["numero8"] != "" && $_POST["numero9"] != "" && $_POST["numero10"] != ""){
                    echo "\nA média dos dez números é: " . mediaAritmetica2($num1,$num2,$num3,$num4,$num5,$num6,$num7,$num8,$num9,$num10);
                    echo "\n O maior número entre os dez é: " . maiorNumero3($num1,$num2,$num3,$num4,$num5,$num6,$num7,$num8,$num9,$num10);
                }             
            ?>
        </textarea>
    </div>
